          ...
          <div className="col-span-12 lg:col-span-7">
            ...
            <div>
              <div className="flex bg-white rounded-2xl p-5 justify-between my-3">
                ...
                <div>
                  <div className="text-base font-medium t-[#232323]">
                    Apple Store
                  </div>
                ...
                <div>
                  ...
                  <div className="text-sm text-[#718EBF]">Envestment Value</div>
                </div>
                <div>
                  <div className="text-base font-medium t-[#232323] text-[#16DBAA]">
                    +16%
                  </div>
                  <div className="text-sm text-[#718EBF]">Return Value</div>
                </div>
              </div>
              <div className="flex bg-white rounded-2xl p-5 justify-between my-3">
                <div>
                ...
                <div>
                  <div className="text-base font-medium t-[#232323] text-[#FE5C73]">
                    -4%
                  </div>
                  <div className="text-sm text-[#718EBF]">Return Value</div>
                </div>
