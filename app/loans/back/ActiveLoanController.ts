...
const activeloansdetaildata = async (token: string) => {
  const response = await axios.get(
    "https://bank-dashboard-6acc.onrender.com/active-loans/detail-data",
    {
      headers: {
        Authorization: `Bearer ${token}`,
        "Content-Type": "application/json",
...
const activeloansmyloans = async (token: string) => {
  const response = await axios.get(
    "https://bank-dashboard-6acc.onrender.com/active-loans/my-loans",
    {
      headers: {
        Authorization: `Bearer ${token}`,
        "Content-Type": "application/json",
...
const activeloansid = async (loanid:string,token: string) => {
  const response = await axios.get(
    `https://bank-dashboard-6acc.onrender.com/active-loans/${loanid}`,
    {
      headers: {
        Authorization: `Bearer ${token}`,
        "Content-Type": "application/json",
...
const activeloansidapprove = async (loanid:string,token: string) => {
  const respons7 = await axios.post(
    `https://bank-dashboard-6acc.onrender.com/active-loans/${loanid}/approve`,
    {},
    {
      headers: {
        Authorization: `Bearer ${token}`,
...
const activeloansidreject = async (loanid:string,token: string) => {
  const response = await axios.post(
    `https://bank-dashboard-6acc.onrender.com/active-loans/${loanid}/reject`,
    {},
    {
      headers: {
        Authorization: `Bearer ${token}`,
...
const activeloans = async ( token: string) => {
  const response = await axios.post(
    "https://bank-dashboard-6acc.onrender.com/active-loans",
    JSON.stringify({
      loanAmount: 1,
      duration: 1,
      interestRate: 1,
