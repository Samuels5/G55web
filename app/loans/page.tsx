...
import { activeloansall, activeloansdetaildata } from "./back/ActiveLoanController";
import {
  Table,
  TableBody,
  TableCaption,
...
interface loantype { personalLoan: number; 
  businessLoan: number;
  ...
  return (
    ...
    <div className="bg-gray-100 p-6 ">
      <div className="flex justify-between gap-8 overflow-x-auto [&::-webkit-scrollbar]:hidden">
        <Card1 text="Personal Loans" img="/personal.png" num={data.personalLoan}/>
        <Card1 text="Corporate Loans" img="/corporate.png" num={data.corporateLoan} />
        <Card1 text="Business Loans" img="/business.png" num={data.businessLoan} />
